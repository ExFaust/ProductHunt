...
public class RecyclerHolder extends RecyclerView.ViewHolder{
    ...
    public void bind(@NonNull PostViewModel postViewModel) {
        mName.setText(postViewModel.getName());
        mTagline.setText(postViewModel.getTagline());
        mVotes.setText(postViewModel.getVotesCount());
        String url = postViewModel.getThumbnailViewModel().getImageUrl();
